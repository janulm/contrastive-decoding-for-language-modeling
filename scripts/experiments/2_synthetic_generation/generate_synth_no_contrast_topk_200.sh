...
TOP_K=200
DATASET_NAME="synth_no_contrast_topk_${TOP_K}"
CD_STRATEGY="no_contrast_top_k"
TITLE="no-contrast-topk-${TOP_K}"
ALPHA=0.1
...
BAD_MODEL_PATH="X"
TRAIN_SCRIPT="/cluster/home/janulm/thesis/ms-thesis/scripts/experiments/3_8000series_all/no_contrast_topk_${TOP_K}.sh"
