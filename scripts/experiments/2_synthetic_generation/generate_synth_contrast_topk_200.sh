...
TOP_K=200
DATASET_NAME="synth_contrast_early_500_topk_${TOP_K}"
CD_STRATEGY="contrast_with_top_k"
TITLE="contrast-early-500-topk-${TOP_K}"
ALPHA=0.1
...
TRAIN_SCRIPT="/cluster/home/janulm/thesis/ms-thesis/scripts/experiments/3_8000series_all/contrast_early_500_topk_${TOP_K}.sh"
