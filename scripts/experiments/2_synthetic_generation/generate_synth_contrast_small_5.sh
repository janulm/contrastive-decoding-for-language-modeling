...
DATASET_NAME="synth_contrast_small_5"
CD_STRATEGY="contrastive"
TITLE="contrast-small-5"
ALPHA=0.1
...
BAD_MODEL_PATH="/cluster/work/cotterell/janulm/thesis_data/checkpoints/models/baseline_training_small/base_llama_8000_small_5_42/step_2500"
NUMB_GPUS=4
