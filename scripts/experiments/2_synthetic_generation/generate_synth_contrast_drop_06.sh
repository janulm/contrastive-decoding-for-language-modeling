...
EXPERIMENT_NAME="synthetic_data_generation_base8000_drop"

DATASET_NAME="synth_contrast_drop_06"
CD_STRATEGY="contrastive_dropout"
TITLE="contrast-drop-06"
DROP_RATE=0.6
ALPHA=0.1
...
BAD_MODEL_PATH="/cluster/work/cotterell/janulm/thesis_data/checkpoints/models/baseline_training/base_llama_8000_43/step_2500"
NUMB_GPUS=4
