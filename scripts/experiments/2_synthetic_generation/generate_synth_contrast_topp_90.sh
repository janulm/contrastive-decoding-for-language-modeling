...
TOP_P_NAME=90
TOP_P=0.90
DATASET_NAME="synth_contrast_early_500_topp_${TOP_P_NAME}"
CD_STRATEGY="contrast_with_top_p"
TITLE="contrast-early-500-topp-${TOP_P_NAME}"
ALPHA=0.1
...
TRAIN_SCRIPT="/cluster/home/janulm/thesis/ms-thesis/scripts/experiments/3_8000series_all/contrast_early_500_topp_${TOP_P_NAME}.sh"
