...
TOP_P_NAME=97
TOP_P=0.97
DATASET_NAME="synth_no_contrast_topp_${TOP_P_NAME}"
CD_STRATEGY="no_contrast_top_p"
TITLE="no-contrast-topp-${TOP_P_NAME}"
ALPHA=0.1
...
BAD_MODEL_PATH="X"
TRAIN_SCRIPT="/cluster/home/janulm/thesis/ms-thesis/scripts/experiments/3_8000series_all/no_contrast_topp_${TOP_P_NAME}.sh"
