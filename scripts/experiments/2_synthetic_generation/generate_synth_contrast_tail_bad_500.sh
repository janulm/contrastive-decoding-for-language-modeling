...
DATASET_NAME="synth_contrast_tail_bad_500"
CD_STRATEGY="contrastive_tail"
TITLE="contrast-tail-bad-500"
ALPHA=0.1
...
OUTPUT_DIR="/cluster/scratch/janulm/thesis/datasets/${EXPERIMENT_NAME}/${DATASET_NAME}"
