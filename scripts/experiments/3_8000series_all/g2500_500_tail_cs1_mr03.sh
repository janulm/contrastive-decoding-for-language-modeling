...
SYNTH_DATA_DIR="/cluster/scratch/janulm/thesis/datasets/synthetic_data_generation_base8000/synth_contrast_tail_bad_500/combined"
SYNTH_DATA_RATIO=0.3
MODEL_NAME="g2500_500_tail_cs1_mr03"
START_SEED=42
NUM_SEEDS=10
