...
TOP_K=50
SYNTH_DATA_DIR="/cluster/work/cotterell/janulm/thesis_data/data/synthetic_data_generation_base8000/synth_contrast_early_500_topk_${TOP_K}_penalty/combined"
SYNTH_DATA_RATIO=0.3
MODEL_NAME="g2500_contrast_early_500_topk_${TOP_K}_mr03_penalty"
START_SEED=47
NUM_SEEDS=4
