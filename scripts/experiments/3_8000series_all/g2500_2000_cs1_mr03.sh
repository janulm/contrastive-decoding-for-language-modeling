...
SYNTH_DATA_DIR="/cluster/work/cotterell/janulm/thesis_data/data/synthetic_data_generation_base8000/synth_contrast_bad_2000/combined"
SYNTH_DATA_RATIO=0.3
MODEL_NAME="g2500_2000_cs1_mr03"
START_SEED=42
NUM_SEEDS=10
