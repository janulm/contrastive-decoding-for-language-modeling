...
SYNTH_DATA_DIR="/cluster/work/cotterell/janulm/thesis_data/data/synthetic_data_generation_base8000/synth_contrast_bad_500/combined"
SYNTH_DATA_RATIO=1.0
MODEL_NAME="g2500_500_cs1_mr10"
START_SEED=47
NUM_SEEDS=5
...
OUTPUT_DIR="/cluster/scratch/janulm/thesis/checkpoint_overflow/${EXPERIMENT_NAME}/${MODEL_NAME}_${seed}"
...
MODEL_PATH="/cluster/scratch/janulm/thesis/checkpoint_overflow/${EXPERIMENT_NAME}/${MODEL_NAME}_${seed}"
