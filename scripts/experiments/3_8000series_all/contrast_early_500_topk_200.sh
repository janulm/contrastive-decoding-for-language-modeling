...
TOP_K=200
SYNTH_DATA_DIR="/cluster/work/cotterell/janulm/thesis_data/data/synthetic_data_generation_base8000/synth_contrast_early_500_topk_${TOP_K}/combined"
SYNTH_DATA_RATIO=0.3
MODEL_NAME="g2500_contrast_early_500_topk_${TOP_K}_mr03"
START_SEED=42
NUM_SEEDS=10
