...
TOP_P_NAME=90
SYNTH_DATA_DIR="/cluster/work/cotterell/janulm/thesis_data/data/synthetic_data_generation_base8000/synth_contrast_early_500_topp_${TOP_P_NAME}/combined"
SYNTH_DATA_RATIO=0.3
MODEL_NAME="g2500_contrast_early_500_topp_${TOP_P_NAME}_mr03"
START_SEED=42
NUM_SEEDS=10
